  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-brand-Gris_oscuro/60 backdrop-blur-sm p-4">
      ...
      >
        ...
        <h2 id="confirm-modal-title" className="text-xl font-title font-bold text-brand-Gris_oscuro mb-2">
          {title}
        </h2>
        <p id="confirm-modal-message" className="text-brand-Gris_oscuro/80 font-body text-sm mb-8">
          {message}
        </p>
